 ...
 * //覆盖在Image上的裁剪框,同时被图片和屏幕使用
 *  computeLayout() 它使用matrix映射从图像空间到屏幕空间
 */
class HighlightView {
    ...
    //maintainAspectRatio: true	imageRect: "Rect(0, 0-1968, 2624)"
    //cropRect: "RectF(197.0, 525.0, 1771.0, 2099.0)"
    //m: "Matrix{[0.58536583, 0.0, 0.0],[0.0, 0.58536583, 70.5][0.0,0.0,1.0]}"
