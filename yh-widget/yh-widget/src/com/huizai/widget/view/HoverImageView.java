...
public class HoverImageView extends ImageView{
	...
	private void setup(AttributeSet attrs) {
		if(attrs != null){
			...
			borderColor = typedArray.getColor(R.styleable.RoundImageView_yh_borderColor, borderColor);
			hoverColor = typedArray.getColor(R.styleable.RoundImageView_yh_hoverColor, hoverColor);
			borderWidth = typedArray.getDimension(R.styleable.RoundImageView_yh_borderWidth, borderWidth);
			typedArray.recycle();
		}
