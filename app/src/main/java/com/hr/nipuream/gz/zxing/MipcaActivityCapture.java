package com.hr.nipuream.gz.zxing;
...
import com.hr.nipuream.gz.zxing.camera.CameraManager;
import com.hr.nipuream.gz.zxing.decoding.CaptureActivityHandler;
import com.hr.nipuream.gz.zxing.decoding.InactivityTimer;
import com.hr.nipuream.gz.zxing.decoding.RGBLuminanceSource;
import com.hr.nipuream.gz.zxing.view.ViewfinderView;
...
public class MipcaActivityCapture extends BaseActivity implements Callback , View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		toolbar.setTitle(R.string.qr_scan);
